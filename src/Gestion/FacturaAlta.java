...
public class FacturaAlta extends JFrame  implements WindowListener, ActionListener
{
	...
	public FacturaAlta() throws ParseException
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(objetoPulsado.equals(btnAceptar))
		{
			...
			try {
				...
				e2.printStackTrace();
				JOptionPane.showMessageDialog(null, "Error en la fecha", "Atención", JOptionPane.WARNING_MESSAGE);
			}
			Date fecha1 = null;
			try {
